...
#define GUINT16_SWAP_LE_BE_CONSTANT(val)                                       \
  ((guint16)((guint16)((guint16)(val) >> 8) | (guint16)((guint16)(val) << 8)))
...
#define GUINT64_SWAP_LE_BE_CONSTANT(val)                                       \
  ((guint64)((((guint64)(val) &                                                \
               (guint64)G_GINT64_CONSTANT(0x00000000000000ffU))                \
              << 56) |                                                         \
             (((guint64)(val) &                                                \
               (guint64)G_GINT64_CONSTANT(0x000000000000ff00U))                \
              << 40) |                                                         \
             (((guint64)(val) &                                                \
               (guint64)G_GINT64_CONSTANT(0x0000000000ff0000U))                \
              << 24) |                                                         \
             (((guint64)(val) &                                                \
               (guint64)G_GINT64_CONSTANT(0x00000000ff000000U))                \
              << 8) |                                                          \
             (((guint64)(val) &                                                \
               (guint64)G_GINT64_CONSTANT(0x000000ff00000000U)) >>             \
              8) |                                                             \
             (((guint64)(val) &                                                \
               (guint64)G_GINT64_CONSTANT(0x0000ff0000000000U)) >>             \
              24) |                                                            \
             (((guint64)(val) &                                                \
               (guint64)G_GINT64_CONSTANT(0x00ff000000000000U)) >>             \
              40) |                                                            \
             (((guint64)(val) &                                                \
               (guint64)G_GINT64_CONSTANT(0xff00000000000000U)) >>             \
              56)))
...
#define GUINT16_SWAP_LE_BE_IA32(val)                                           \
  (G_GNUC_EXTENSION({                                                          \
    ...
    !defined(__i686__) && !defined(__pentiumpro__) && !defined(__pentium4__)
...
#define GUINT64_SWAP_LE_BE_IA64(val)                                           \
  (G_GNUC_EXTENSION({                                                          \
    ...
    if (__builtin_constant_p(__x))                                             \
      ...
      __asm__ __volatile__("mux1 %0 = %1, @rev ;;" : "=r"(__v) : "r"(__x));    \
    __v;                                                                       \
  }))
...
static inline gboolean _GLIB_CHECKED_ADD_UINT64(guint64 *dest, guint64 a,
                                                guint64 b) {
  *dest = a + b;
  return *dest >= a;
}
static inline gboolean _GLIB_CHECKED_MUL_UINT64(guint64 *dest, guint64 a,
                                                guint64 b) {
  *dest = a * b;
  return !a || *dest / a == b;
}
