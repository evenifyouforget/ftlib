...
int _fcsim_is_digit(char c) { return '0' <= c && c <= '9'; }

void _fcsim__fcsim_bignum_t_muladd(struct _fcsim_bignum_t *_fcsim_bignum_t,
...
double
_fcsim__fcsim_bignum_t_to_double(struct _fcsim_bignum_t *_fcsim_bignum_t) {
  uint32_t words[4] = {0};
  int high_bits;
  uint64_t mantissa;
  int half_bit;
