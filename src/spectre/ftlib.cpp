...
double ft_sqrt(double x) { return std::sqrt(x); }
double ft_sin(double x) { return std::sin(x); }
double ft_cos(double x) { return std::cos(x); }
double ft_atan2(double y, double x) { return std::atan2(y, x); }
#else
#ifdef S794
double ft_sin(double x) { return s794_sin(x); }
double ft_cos(double x) { return s794_cos(x); }
#else
double ft_sin(double x) { return ftref_sin(x); }
double ft_cos(double x) { return ftref_cos(x); }
#endif
#endif
