...
// intentionally in the same order as the render enum, so they can be converted
// back and forth, and the render bindings can be used for this
...
inline bool type_is_player(int t) { return t >= fcsim_piece_type::GP_RECT; }
